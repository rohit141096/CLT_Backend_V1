...
module.exports.validateEnum = async (value, enums) => {
  const check = enums.includes(value);
...
module.exports.validateIPaddress = async (ipaddress) => {
  let pattern =
    /^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/;

  const check = ipaddress.match(pattern);
  if (check) {
    return {
      status: true,
      message: "Success",
